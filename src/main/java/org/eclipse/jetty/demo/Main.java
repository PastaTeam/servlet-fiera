...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ------
        AziendeHandler aziendeHandler = new AziendeHandler();
        ServletRepository.pathMap.put("aziende", aziendeHandler);

        ProdottiHandler prodottiHandler = new ProdottiHandler();
        ServletRepository.pathMap.put("prodotti", prodottiHandler);
    ...
    private ServletContextHandler getServletContextHandler(URI baseUri, File scratchDir) {
        ...
        sch.addServlet(getAPIServletHolder(), "/api/*");
        return sch;
    }
    ...
    private ServletHolder getAPIServletHolder () {
        return new ServletHolder(new ServletEntryPoint());
    }
